...
<body>
    ...
    <div class="container">
      ...
      <div class="blueBannerHeading">
        <h1 class="blueBannerTitleWithSubtitle">
          <a style="color: #ffffff">Oracle Container Cloud Service + Wercker (CD STEP by fevzimfk)</a>
        </h1>
      </div>
  ...
  <div class="container serviceContainer" style="margin-top: 150px;">
    <div class="overviewLayout">
      <div>
              <br>SpringBoot application demo by Fevzi Korkutata. Current server time: <%= new java.util.Date() %> <br>
              <br>
              <p>
